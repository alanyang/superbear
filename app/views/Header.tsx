...
import { appearanceState, useAppearance, useCurrent, useUI, uiState } from "~/utils/store";
...
const ViewSwither = () => {
  ...
  const gridBorder = view === 'grid' ? 'border-slate-500' : 'border-slate-50'
...
const Avatar = () => {
  ...
  return (
    <div className="flex justify-center items-center p-5 rounded-full bg-blue-500 text-white relative">
      {
        user.avatar ?
          <img src={user.avatar} /> :
